  ...
  return (
    ...
    <div className="container">
      ...
      <Navbar.Brand href="/" className=" fw-bold fs-4 fst-italic">e-Commerce Template</Navbar.Brand>
        ...
        <form className="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3 justify-content-between d-flex">
          <input type="search" className="form-control form-control-dark" placeholder="Search..."/>
           <NavLink to="/searchPage" className="btn btn-success mx-2"><i className="bi bi-search"></i></NavLink>
        </form>
        <div className="text-start">
          <NavLink to="/cartPage" className="btn btn-success me-2 position-relative" title="Cart">
          <i className="bi bi-cart4">
          <span className="position-absolute top-0 start-100  translate-middle badge rounded-pill bg-danger">0</span>
          </i></NavLink>
          <NavLink to="/wishPage" className="btn btn-success me-2 position-relative" title="Wish List">
